...
- **Compact and card views.** Compact keeps the library dense and scannable. Cards expand into a responsive grid with up to four columns on large displays. Pick either in Settings.
