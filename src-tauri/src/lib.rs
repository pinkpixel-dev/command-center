...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ipc::ai_codex::start_codex_login,
            ipc::ai_codex::await_codex_login,
            ipc::ai_codex::cancel_codex_login,
            ipc::ai_codex::disconnect_codex,
            ipc::ai_codex::list_codex_models,
